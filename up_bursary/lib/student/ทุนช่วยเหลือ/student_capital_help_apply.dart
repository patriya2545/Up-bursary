...
class Student_Capital_Hepl_Apply extends StatefulWidget {
  const Student_Capital_Hepl_Apply({super.key});

  @override
  State<Student_Capital_Hepl_Apply> createState() => _Student_Capital_Hepl_ApplyState();
}

class _Student_Capital_Hepl_ApplyState extends State<Student_Capital_Hepl_Apply> {
  @override
  late double screen;
  ...
  Container buildApply() {
    return Container(
            ...
            child: ElevatedButton(
              onPressed: () => Navigator.pushNamed(context, '/studen_capital_help_finish') ,
              child: Text('สมัครทุน',
              style: TextStyle(
                fontSize: 22,),
              ),            
